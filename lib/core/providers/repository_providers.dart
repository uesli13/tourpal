...
// Tour Session Services (simplified for fast deployment)
...
import '../../features/tour_session/presentation/bloc/tour_session_bloc.dart';
...
class RepositoryProviders {
  static List<Provider> get providers => [
    ...
    // Services (simplified for immediate deployment)
    ...
    // CRITICAL FIX: Simplified services for live tour functionality
  ...
  static List<BlocProvider> get blocProviders => [
    ...
    BlocProvider<TourSessionBloc>(
      create: (context) => TourSessionBloc(
        tourSessionService: context.read<TourSessionService>(),
      ),
    ),
  ];
}