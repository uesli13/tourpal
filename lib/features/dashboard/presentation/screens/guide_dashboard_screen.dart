...
class _GuideDashboardScreenState extends State<GuideDashboardScreen> {
  ...
  Future<void> _loadMyTours() async {
    try {
      ...
      AppLogger.logInfo('Error loading my tours: $e');
    }
  }
  ...
  Future<void> _loadStats() async {
    try {
      ...
      AppLogger.logInfo('Error loading stats: $e');
    }
  }
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: isActive 
              ...
              : [AppColors.guide.withValues(alpha: 0.8), AppColors.guide],
        ...
        boxShadow: [
          BoxShadow(
            color: (isActive ? Colors.green : AppColors.guide).withValues(alpha: 0.3),
            blurRadius: 8,
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 40,
            decoration: BoxDecoration(
              color: AppColors.guide.withValues(alpha: 0.2),
              borderRadius: BorderRadius.circular(8),
            ),
            child: const Icon(
              Icons.tour,
